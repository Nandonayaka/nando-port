...
export default function FileExplorer() {
  ...
  return (
    <div className={`w-full md:w-60 bg-[#0c1017] border-r border-[#1f242c] flex-col h-screen text-[#9099a4] font-sans select-none flex-shrink-0 ${activeFile ? 'hidden md:flex' : 'flex'}`}>
        ...
        {projectFiles.map((file, idx) => {
          ...
          return (
            <div
              ...
              style={indentStyle}
              onClick={() => {
                if (!file.isFolder) setActiveFile(file.name);
              }}
